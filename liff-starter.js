...
function getP(){
    ...
    if (!tipe) {
        ...
        document.getElementById('videox').addEventListener('click', function () {
            liff.sendMessages([{
                type: 'text',
                text: atob('bGluZTovL2FwcC8xNjIyOTk0ODU3LVJWVkc0bFpnP3R5cGU9dmlkZW8mb2N1PWh0dHBzOi8vdGlueXVybC5jb20veThvZzNvcjUmcGl1PWh0dHBzOi8vaW1hZ2VzNi5hbHBoYWNvZGVycy5jb20vNzEwL3RodW1iLTM1MC03MTAxMzIucG5nCgp0eXBlID0+IHZpZGVvCm9jdSA9PiB2aWRlbyB1cmwKcGl1ID0+IHByZXZpZXcgaW1hZ2U=')
            }]).then(function () {
                liff.closeWindow();
            });
        });
        ...
        document.getElementById('stickerx').addEventListener('click', function () {
            liff.sendMessages([{
                type: 'text',
                text: atob('')
            }]).then(function () {
                liff.closeWindow();
            });
        });
            ...
            liff.sendMessages([{
                ...
                template: {
                    ...
                    actions: [
                        {
                            type:"uri",
                            label: prof.displayName + " send Profile"
